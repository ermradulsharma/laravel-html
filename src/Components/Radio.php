...
class Radio extends FormComponent
{
    ...
    public function __construct(FormBuilder $form, $name, $value = null, $checked = null, $options = [], $label = null)
    {
    ...
    public function render()
    {
        return function (array $data) {
            $html = '';
            $html .= $this->form->radio($this->name, $this->value, $this->checked, $this->options);
            if ($this->label) {
